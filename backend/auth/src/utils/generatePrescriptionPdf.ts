...
export interface PrescriptionData {
  ...
  prescriptionItems: PrescriptionInput[];
}

function generatePrescriptionId(length = 12): string {
...
export async function generatePrescriptionPdf(
  ...
  return new Promise((resolve, reject) => {
    ...
    if (data.clinicLogoPath && fs.existsSync(data.clinicLogoPath)) {
